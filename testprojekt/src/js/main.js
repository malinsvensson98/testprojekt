...
function getCourses() {
    coursesEl.innerHTML = '';
    fetch("http://localhost/projekt_webb3/api/read.php")
...
function addCourse() {
    ...
    fetch("http://localhost/projekt_webb3/api/create.php", {
            method: "POST",
...
function deleteCourse(id) {
    fetch("http://localhost/projekt_webb3/api/delete.php?id=" + id, {
            method: "DELETE",
        })
        .then(response => response.json())
        .then(data => {
...
function getOneToUpdate(id) {
    ...
    fetch('http://localhost/projekt_webb3/api/read_one.php?id=' + id)
        .then(response => response.json())
...
function updateCourse(id) {
    ...
    fetch('http://localhost/projekt_webb3/api/update.php?id=' + id, {
            method: 'PUT',
            body: JSON.stringify(courses)
        })
        .then(response => response.json())
